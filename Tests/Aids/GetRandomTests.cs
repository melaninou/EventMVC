...
namespace Tests.Aids
{
    ...
    public class GetRandomTests :BaseTests
    {
        ...
        public void UInt64Test()
        {
            ...
            doGetRandomTests(GetRandom.UInt64, ulong.MinValue, uint.MinValue + d);
        ...
        public void ValueTest()
        {
            ...
            test(typeof(EventType?), typeof(EventType));
        ...
        public void ObjectTest()
        {
            ...
            var o = GetRandom.Object(typeof(EventDbRecord)) as EventDbRecord;
            Assert.IsNotNull(o);
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.ID));
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.Description));
